...
import { Character, CreateMoveset, GetMovesetObjectByName, Skill, SkillDecorator } from "exports";
...
export = function () {
    ...
    it("should respect constructor arguments", () => {
        ...
        const moveset = CreateMoveset("someMoveset", [test_skill1], { test_skill1: [10] });
        const char = makeChar();
