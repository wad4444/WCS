...
export declare class Character {
    private static readonly _currentCharMap;
    ...
    private readonly _statusEffects;
    private readonly _skills;
    private _defaultsProps;
    private _id;
    private _moveset?;
    ...
    private _setupReplication_Client;
    private _updateHumanoidProps;
}
