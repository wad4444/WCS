...
export declare abstract class HoldableSkill<StarterParams = void, ConstructorArguments extends unknown[] = [
], Metadata = void, ServerToClientMessage = void, ClientToServerMessage = void> extends Skill<StarterParams, ConstructorArguments, Metadata, ServerToClientMessage | {
