...
### `StateChanged`
Fires whenever current [status effect state](../tutorial/status effects/state.md) changes.
...
### `HumanoidDataChanged`
Fires whenever current [Humanoid Data](../tutorial/status effects/state.md) changes.
