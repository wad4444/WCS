...
/** @hidden @internal */
export declare abstract class SkillBase<StarterParams = void, ConstructorArguments extends unknown[] = [], Metadata = void, ServerToClientMessage = void, ClientToServerMessage = void> {
    /** @internal @hidden */
...
/** A skill class. */
export declare abstract class Skill<StarterParams = void, ConstructorArguments extends unknown[] = [], Metadata = void, ServerToClientMessage = void, ClientToServerMessage = void> extends SkillBase<StarterParams, ConstructorArguments, Metadata, ServerToClientMessage, ClientToServerMessage> {
    constructor(Character: Character, ...Args: ConstructorArguments);
}
/**
